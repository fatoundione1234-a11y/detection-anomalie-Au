...
TYPE_ICON  = {"aurifere":"*","sterile":"o","structure":"#"}
...
with col_map:
   ...
   m = folium.Map(
    ...
    for _, z in df.iterrows():
        ...
        <div style='font-family:monospace;font-size:12px;min-width:200px;
          ...
          <table style='width:100%;font-size:11px;'>
            ...
            <tr><td style='color:#888;'>Score IA</td><td style='color:#fff;'>{z.score_ia}/100</td></tr>
            <tr><td style='color:#888;'>Priorite</td><td style='color:{PRIO_COLOR[z.priorite]};'>{z.priorite}</td></tr>
            <tr><td style='color:#888;'>Surface</td><td style='color:#fff;'>{z.surface} km2</td></tr>
            <tr><td style='color:#888;'>NDVI</td><td style='color:#fff;'>{z.ndvi}</td></tr>
            <tr><td style='color:#888;'>SWIR</td><td style='color:#fff;'>{z.band_ratio}</td></tr>
            <tr><td style='color:#888;'>Mineraux</td><td style='color:#fff;font-size:10px;'>{z.mineraux}</td></tr>
          </table>
            ...
            folium.Marker(
                ...
                icon=folium.DivIcon(
                    html=f"""<div style='
                        ...
                        color:{c};background:rgba(7,17,29,0.85);
    ...
    <div style='position:fixed;bottom:30px;left:30px;z-index:1000;
                ...
                font-size:12px;color:#e2e8f0;box-shadow:0 4px 20px rgba(0,0,0,0.5);'>
...
with col_detail:
    ...
    st.markdown(
        f"<div style='font-size:10px;color:rgba(255,255,255,0.6);padding:10px;"
